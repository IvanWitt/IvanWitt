...
1. Find the translation file corresponding to your language, for example, Japanese is [app/src/main/res/values-ja/strings.xml](https://github.com/IvanWitt/IvanWittClient/blob/dev/app/src/main/res/values-ja/strings.xml).
