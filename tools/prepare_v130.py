...
# Remove every HTML startup splash block.
while True:
...
# Remove historical startup splash CSS.
...
# Remove historical startup splash JS.
...
# Inject all runtime fixes before DOMContentLoaded can fire. Calendar mechanism loads last and overrides only the old gears page hooks.
tags=(
    ...
    '    <script src="calendar-mechanism-v2.js"></script>\n'
)
for tag in [
    '<script src="tzolkin-sequence-fix.js"></script>',
    '<script src="moon-calendar-v2.js"></script>',
...
# Remove obsolete custom splash assets.
for rel in [
...
# Neutral Android 12+ launch surface.
...
g=re.sub(r"versionName\s+'[^']+'","versionName '1.3.0'",g)
gradle.write_text(g,'utf-8')

print('Prepared v1.3.0: isolated stone/wood calendar mechanism with 52/73/73 teeth and long-count rack.')
